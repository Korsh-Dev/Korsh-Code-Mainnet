...
This document provides guidelines for internationalization of the Korsh Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Korsh network</numerusform>
            <numerusform>%n active connections to Korsh network</numerusform>
        </translation>
    </message>

...
Assumeutxo is a feature that allows fast bootstrapping of a validating korshd
...
considered active. This is the "traditional" mode of operation for korshd.
...
**Failure consideration:** if korshd unexpectedly halts after `m_stop_use` is set on
...
When korshd initializes again, what began as the snapshot chainstate is now

# Support for Output Descriptors in Korsh Core

Since Korsh Core v0.17, there is support for Output Descriptors. This is a
...
existing Korsh Core wallets, a convenience function `combo` is
...
All RPCs in Korsh Core will include the checksum in their output. Only

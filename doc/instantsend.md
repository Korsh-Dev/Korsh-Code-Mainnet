...
This mechanism has been integrated into Bitcore-Node-Korsh which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dashpay/insight-api-korsh#web-socket-api](https://github.com/dashpay/insight-api-korsh#web-socket-api)
* API: [https://github.com/dashpay/insight-api-korsh#instantsend-transactions](https://github.com/dashpay/insight-api-korsh#instantsend-transactions)

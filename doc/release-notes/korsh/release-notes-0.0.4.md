# Korsh Core version v0.0.4

Korsh Core `v0.0.4` focuses on masternode usability for miners/operators who want an all-in-one setup.
...
- Updated ProTx RPC help collateral amounts to match current consensus:
  - Regular masternode collateral: `15,000 KSH`
  - EvoNode collateral: `75,000 KSH`
- Added an English setup guide:
  ...
  - Direct link: https://github.com/SmartiesCoin/Korsh/blob/main/doc/masternode-setup-smt.md

# Korsh Core version v0.0.5

Korsh Core `v0.0.5` focuses on masternode onboarding in the Qt wallet with a guided setup flow.
...
- Added automatic `korsh.conf` operator key update:

...
from other quorum members. This allows Korsh Platform to obtain required
...
Platform support
----------------
Support for Korsh Platform has been expanded through the addition of a new
...
BLS update
----------
Korsh Core’s BLS signature library has been updated based on v1.0 of the
...
--------------------------------
This version of Korsh Core includes multiple optimizations to the network and
...
Statoshi backport
------------------
This version includes a [backport](https://github.com/SmartiesCoin/Korsh/pull/2515)
...
RPC changes
-----------
There are seven new RPC commands which are Korsh specific and seven new RPC
...
Korsh users. Bitcoin changes that do not align with Korsh’s product needs, such
...
See detailed [set of changes](https://github.com/SmartiesCoin/Korsh/compare/v0.16.1.1...dashpay:v0.17.0.2).

...
- SPV clients can now detect and track Korsh-specific transactions
...
* Performance of block validation in Korsh Core has been significantly improved, index from
  scratch and reindex are up to 20% faster compared to v22.x.
* To help prevent fingerprinting transactions created by the Korsh Core wallet, change output
  amounts are now randomized. (#6685)
* Korsh Core will no longer migrate EvoDb databases generated in v19 and v20, users upgrading
...
- `PROTO_VERSION` has been bumped to `70238` with the introduction of the `platformban` p2p message.
  This message allows evonodes to initiate PoSe masternode banning in Korsh Core for evonodes which are
  not providing adequate service on Korsh Platform.
- `cycleHash` field in `isdlock` message will now represent a DKG cycle starting block of the signing quorum instead of a DKG cycle starting block corresponding to the current chain height. While this is fully backwards compatible with older versions of Korsh Core, other implementations might not be expecting this, so the P2P protocol version was bumped to 70237. (#6608)
...
* The RPCs `protx register_legacy`, `protx register_fund_legacy`, `protx register_prepare_legacy` and
  `protx update_registrar_legacy` have been deprecated in Korsh Core v23 and may be removed in a future version.
  They can be re-enabled with the runtime argument `-deprecatedrpc=legacy_mn`.

* The argument `legacy` in `bls generate` has been deprecated in Korsh Core v23 and may be ignored in a future version.
...
* The `instantsendtoaddress` RPC was deprecated in Korsh Core v0.15 and is now removed. (#6686)
...
* The RPCs `masternode current` and `masternode winner` were deprecated in Korsh Core v0.17 and are now removed. The `getpoolinfo` RPC was deprecated in Korsh Core v0.15 and is now removed. (#6567)
...
Korsh Core v23 introduces support for extended masternode addresses, replacing legacy single-endpoint fields and
...
* If the masternode is eligible for extended addresses, `protx register{,_evo}` and `protx register_fund{,_evo}` will:
  ...
  * Continue to allow specifying only the port number for `platformP2PAddrs` and `platformHTTPSAddrs`, pairing it with the address
    ...
    * This method of entry may not be available in future releases of Korsh Core and operators are recommended to switch over to
...
GCC 11.1 or later, or Clang 16.0 or later, are now required to compile Korsh Core. (#6389)
...
- Fixed an issue where CoinJoin funds mixed in the Korsh Android wallet were invisible when importing the mnemonic into Korsh Core. Descriptor Wallets now include an additional default descriptor for mobile CoinJoin funds, ensuring seamless wallet migration and complete fund visibility across different Korsh wallet implementations.
...
- [v22.1.3](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-22.1.3.md) released Jul/15/2025
- [v22.1.2](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-22.1.2.md) released Apr/15/2025
- [v22.1.1](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-22.1.1.md) released Feb/17/2025
- [v22.1.0](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-22.1.0.md) released Feb/10/2025
- [v22.0.0](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-22.0.0.md) released Dec/12/2024
- [v21.1.1](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-21.1.1.md) released Oct/22/2024
- [v21.1.0](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-21.1.0.md) released Aug/8/2024
- [v21.0.2](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-21.0.2.md) released Aug/1/2024
- [v21.0.0](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-21.0.0.md) released Jul/25/2024
- [v20.1.1](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-20.1.1.md) released April/3/2024
- [v20.1.0](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-20.1.0.md) released March/5/2024
- [v20.0.4](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-20.0.4.md) released Jan/13/2024
- [v20.0.3](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-20.0.3.md) released December/26/2023
- [v20.0.2](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-20.0.2.md) released December/06/2023
- [v20.0.1](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-20.0.1.md) released November/18/2023
- [v20.0.0](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-20.0.0.md) released November/15/2023
- [v19.3.0](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-19.3.0.md) released July/31/2023
- [v19.2.0](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-19.2.0.md) released June/19/2023
- [v19.1.0](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-19.1.0.md) released May/22/2023
- [v19.0.0](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-19.0.0.md) released Apr/14/2023
- [v18.2.2](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-18.2.2.md) released Mar/21/2023
- [v18.2.1](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-18.2.1.md) released Jan/17/2023
- [v18.2.0](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-18.2.0.md) released Jan/01/2023
- [v18.1.1](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-18.1.1.md) released January/08/2023
- [v18.1.0](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-18.1.0.md) released October/09/2022
- [v18.0.2](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-18.0.2.md) released October/09/2022
- [v18.0.1](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-18.0.1.md) released August/17/2022
- [v0.17.0.3](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-0.17.0.3.md) released June/07/2021
- [v0.17.0.2](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-0.17.0.2.md) released May/19/2021
- [v0.16.1.1](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-0.16.1.1.md) released November/17/2020
- [v0.16.1.0](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-0.16.1.0.md) released November/14/2020
- [v0.16.0.1](https://github.com/SmartiesCoin/Korsh/blob/master/doc/release-notes/korsh/release-notes-0.16.0.1.md) released September/30/2020
...
[set-of-changes]: https://github.com/SmartiesCoin/Korsh/compare/v22.1.3...dashpay:v23.0.0
...
Korsh Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Korsh Core

**Korsh Core's `configure` script by default will ignore the depends output.** In
...
options will be passed to Korsh Core's configure. In this case, `--disable-wallet`.

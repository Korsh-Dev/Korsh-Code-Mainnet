...
"""Script for verifying Korsh Core release binaries
...
HASHFILE = "hashes.tmp"
HOST1="https://github.com/dashpay/korsh/releases/download/v"
...
def main(args):
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Korsh Core binary release "
    ...
    for _, binary_filename in hashes_to_verify:
        ...
        if retval != 0:
            if retval == 1:
                ...
                print("gpg error. Do you have the Korsh Core binary release signing key installed?")
            print("gpg output:")
            print(indent(output, '\t'))

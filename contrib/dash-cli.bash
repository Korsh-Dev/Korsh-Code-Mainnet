# bash programmable completion for korsh-cli(1)
# Copyright (c) 2012-2019 The Bitcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

# call $korsh-cli for RPC
_dash_rpc() {
...
_dash_cli() {
    ...
    # save and use original argument to invoke korsh-cli for -help, help and RPC
    # as korsh-cli might not be in $PATH
    dash_cli="$1"
    ...
    case "$cur" in
        ...
        *)
            ...
            if [[ -z "$cur" || "$cur" =~ ^- ]]; then
                helpopts=$($dash_cli -help 2>&1 | awk '$1 ~ /^-/ { sub(/=.*/, "="); print $1 }' )
            fi
...
complete -F _dash_cli korsh-cli

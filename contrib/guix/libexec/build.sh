...
(
    ...
    # Setup the directory where our Korsh Core build for HOST will be
    # installed. This directory will also later serve as the input for our
    # binary tarballs.
    INSTALLPATH="${PWD}/installed/${DISTNAME}"
    mkdir -p "${INSTALLPATH}"
    # Install built Korsh Core to $INSTALLPATH
    ...
    (
        ...
        # copy over the example korsh.conf file. if contrib/devtools/gen-korsh-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/contrib/debian/examples/korsh.conf" "${DISTNAME}/"

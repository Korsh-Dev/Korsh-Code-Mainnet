# Linearize
Construct a linear, no-fork, best version of the Korsh blockchain.

## Step 0: Install dash_hash

https://github.com/SmartiesCoin/Korsh_hash
...
JSON-RPC server. Running `korshd` or `korsh-qt -server` will be sufficient.
...
* `input`: korshd blocks/ directory containing blkNNNNN.dat

...
BOOST_AUTO_TEST_CASE(bnb_search_test)
{
    ...
    }
    {
        ...
        // NOTE: Korsh does not use BnB and therefore, this check will fail
...
BOOST_AUTO_TEST_CASE(knapsack_solver_test)
{
    ...
    for (int i = 0; i < RUN_TESTS; i++)
    {
        ...
        BOOST_CHECK_EQUAL(result14->GetSelectedValue(), 1 * COIN);  // we should get 1 KSH in 1 coin
        ...
        BOOST_CHECK_EQUAL(result15->GetSelectedValue(), 2 * COIN);  // we should get 2 KSH in 1 coin

...
enum ServiceFlags : uint64_t {
    ...
    // set by all Korsh Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
...
enum GetDataMsg : uint32_t {
    ...
    MSG_SPORK = 6,
    /* 7 - 15 were used in old Korsh versions and were mainly budget and MN broadcast/ping related*/
    MSG_DSTX = 16,

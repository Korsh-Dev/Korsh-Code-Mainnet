...
//! Interface for the src/evo part of a korsh node (dashd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a korsh node (dashd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a korsh node (dashd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a korsh node (dashd process).
...
//! Top-level interface for a korsh node (dashd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or korsh.conf.

...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "sendtoshieldaddress", 1, "amount" },
    { "sendtoshieldaddress", 2, "minconf" },
    { "sendtoshieldaddress", 3, "fee" },
    { "sendtoshieldaddress", 4, "verbose" },
    { "sendfromshieldaddress", 2, "amount" },
    { "sendfromshieldaddress", 3, "minconf" },
    { "sendfromshieldaddress", 4, "fee" },
    { "sendfromshieldaddress", 5, "verbose" },
    { "getshieldbalance", 1, "minconf" },
    { "getshieldbalance", 2, "include_unspendable" },
    { "listshieldunspent", 0, "minconf" },
    { "listshieldunspent", 2, "include_unspendable" },

...
BOOST_FIXTURE_TEST_CASE(korsh_reward_reallocation_rules, TestingSetup)
{
    ...
    BOOST_CHECK_EQUAL(GetMasternodePayment(consensus.nKSHv030Height, post_treasury_block_value, /*fV20Active=*/true),
...
// #if 0 until the test is rewritten against the Korsh rules; the reward

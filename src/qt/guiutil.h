...
/** Utility functions used by the Korsh Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "korsh:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Check if a korsh specific theme is activated (light/dark).*/

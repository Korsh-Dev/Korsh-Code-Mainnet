...
cp "$BASE_ROOT_DIR"/src/korsh-cli $DOCKER_RELATIVE_PATH/bin/
cp "$BASE_ROOT_DIR"/src/korsh-tx  $DOCKER_RELATIVE_PATH/bin/
strip $DOCKER_RELATIVE_PATH/bin/dashd
strip $DOCKER_RELATIVE_PATH/bin/korsh-cli
strip $DOCKER_RELATIVE_PATH/bin/korsh-tx

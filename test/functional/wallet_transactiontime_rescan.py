...
class TransactionTimeRescanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]    # node used to mine KSH and create transactions
        ...
        # generate some KSH to create transactions and check blockcount
        ...
        # send 10 KSH to user's first watch-only address
        self.log.info('Send 10 KSH to user')
        ...
        # send 5 KSH to our second watch-only address
        self.log.info('Send 5 KSH to user')
        ...
        # send 1 KSH to our third watch-only address
        self.log.info('Send 1 KSH to user')

...
# Keep mocktime aligned with regtest genesis in src/chainparams.cpp.
TIME_GENESIS_BLOCK = 1590000000
...
"""
Korsh chaintips rpc returns extra info in each tip (difficulty, chainwork, and

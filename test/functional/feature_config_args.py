...
class ConfArgsTest(BitcoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(os.path.join(self.nodes[0].datadir, 'korsh.conf'), 'a', encoding='utf-8') as conf:
        ...
        with open(inc_conf_file_path, 'w', encoding='utf-8') as conf:
            conf.write('-korsh=1\n')
        self.nodes[0].assert_start_raises_init_error(expected_msg='Error: Error reading configuration file: parse error on line 1: -korsh=1, options in configuration file must be specified without leading -')
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "korsh.conf")

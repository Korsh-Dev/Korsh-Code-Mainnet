...
# Formatting. Default colors and symbols.
...
BASE_SCRIPTS = [
    ...
    'feature_governance_height_schedule.py',
...
def main():
    ...
    tmpdir = os.path.join(args.tmpdirprefix, "test_runner_%s" % datetime.datetime.now().strftime("%Y%m%d_%H%M%S"))
...
class RPCCoverage():
    ...
    commands per `korsh-cli help` (`rpc_interface.txt`).
